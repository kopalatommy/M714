...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OzoneForm_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 114, 13),
QT_MOC_LITERAL(7, 128, 11)
    },
...
void OzoneForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OzoneForm *_t = static_cast<OzoneForm *>(_o);
        switch (_id) {
...
const QMetaObject OzoneForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OzoneForm.data,
      qt_meta_data_OzoneForm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OzoneForm.stringdata))
        return static_cast<void*>(const_cast< OzoneForm*>(this));
