...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SettingsForm_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 35, 0)
    ...
    "SettingsForm\0on_backButton_clicked\0"
};
...
const QMetaObject SettingsForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SettingsForm.data,
      qt_meta_data_SettingsForm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingsForm.stringdata))
