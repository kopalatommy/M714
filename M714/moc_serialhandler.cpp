...
void SerialHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialHandler::ReceivedNewData)) {
                *result = 0;
            }
        }
        {
            typedef void (SerialHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialHandler::ReceivedError)) {
                *result = 1;
            }
        }
        {
            typedef void (SerialHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialHandler::ReceivedAck)) {
                *result = 2;
            }
        }
        {
            typedef void (SerialHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialHandler::ParsedData)) {
                *result = 3;
            }
        }
    }
