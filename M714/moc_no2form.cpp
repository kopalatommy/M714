...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NO2Form_t, stringdata) + ofs \
...
const QMetaObject NO2Form::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NO2Form.data,
      qt_meta_data_NO2Form,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NO2Form.stringdata))
        return static_cast<void*>(const_cast< NO2Form*>(this));
